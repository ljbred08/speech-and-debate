# Debt ceiling brinksmanship has clear negative effects on taxpayers | Brookings

Source: [https://www.brookings.edu/articles/debt-ceiling-brinksmanship-has-clear-negative-effects-on-taxpayers/](https://www.brookings.edu/articles/debt-ceiling-brinksmanship-has-clear-negative-effects-on-taxpayers/)
...
Up until now, the U.S. government has enjoyed a borrowing rate that is estimated to be lower by roughly ¼ percentage point, meaning interest savings of more than [$750 billion](https://www.hamiltonproject.org/publication/post/how-worried-should-we-be-if-the-debt-ceiling-isnt-lifted/https:/www.hamiltonproject.org/publication/post/how-worried-should-we-be-if-the-debt-ceiling-isnt-lifted/) over the next decade. If a portion of this advantage were lost by allowing the debt limit to bind, the cost to the taxpayer could be significant. Already, financial markets are concerned.
...
![Figure 1: April and May 2023 Yield Curves](https://i0.wp.com/www.brookings.edu/wp-content/uploads/2023/05/20230523_THP_DebtCeilingYieldCurve_Fig1.png?fit=400%2C9999px\&quality=1#038;ssl=1)

Figure 1: April and May 2023 Yield Curves
...
In 2013, there was a similar increase in the interest rates on Treasury bills scheduled to mature near the anticipated X-date, October 17. As shown in figure 3, like in 2011, there was a nearly 30 basis point increase in yields on these bills between late September (light green line) and mid-October (dark green line). As discussed in a [Hutchins Center Explains post](https://www.brookings.edu/blog/up-front/2019/03/15/the-hutchins-center-explains-the-debt-limit/), when Congress waited until the last minute to raise the debt ceiling in 2013, rates rose on Treasury securities scheduled to mature near the projected date the debt limit was expected to bind—by between 21 basis points and 46 basis points, according to an [estimate](https://www.federalreserve.gov/econres/feds/files/2017052pap.pdf) from Federal Reserve economists—and liquidity in the Treasury securities market contracted. Yields across all maturities also increased a bit—by [between 4 basis points and 8 basis points](https://www.federalreserve.gov/econres/feds/files/2017052pap.pdf)—reflecting investors’ fears of broader financial contagion.

![Figure 2: Yield Curves Around the X-date in 2011 and 2013](https://i0.wp.com/www.brookings.edu/wp-content/uploads/2023/05/20230523_THP_DebtCeilingYieldCurve_Fig2.png?fit=400%2C9999px\&quality=1#038;ssl=1)

Figure 2: Yield Curves Around the X-date in 2011 and 2013

Should the debt ceiling bind, the negative economic effects would quickly mount and risk triggering a deep recession. As Edelberg and Louise Sheiner discussed in a recent [piece](https://www.hamiltonproject.org/publication/post/how-worried-should-we-be-if-the-debt-ceiling-isnt-lifted/https:/www.hamiltonproject.org/publication/post/how-worried-should-we-be-if-the-debt-ceiling-isnt-lifted/):
...
_The Brookings Institution is financed through the support of a diverse array of foundations, corporations, governments, individuals, as well as an endowment. A list of donors can be found in our annual reports published online [here](https://www.brookings.edu/about-us/annual-report/). The findings, interpretations, and conclusions in this report are solely those of its author(s) and are not influenced by any donation._

Related Content

__The Brookings Institution is committed to quality, independence, and impact.__We are supported by a [diverse array of funders](https://www.brookings.edu/about-us/annual-report/). In line with our [values and policies](https://www.brookings.edu/about-us/research-independence-and-integrity-policies/), each Brookings publication represents the sole views of its author(s).
